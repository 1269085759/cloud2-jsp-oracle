...
function HttpUploaderMgr()
{
	...
	this.Config = {
        ...
        , "Cloud"           : null//云存储
		//文件夹操作相关
		, "UrlFdCreate"		: "http://localhost:8080/Cloud2Oracle/db/fd_create.jsp"
		, "UrlFdComplete"	: "http://localhost:8080/Cloud2Oracle/db/fd_complete.jsp"
		, "UrlFdDel"	    : "http://localhost:8080/Cloud2Oracle/db/fd_del.jsp"
		//文件操作相关
		, "UrlCreate"		: "http://localhost:8080/Cloud2Oracle/db/f_create.jsp"
		, "UrlProcess"		: "http://localhost:8080/Cloud2Oracle/db/f_process.jsp"
		, "UrlComplete"		: "http://localhost:8080/Cloud2Oracle/db/f_complete.jsp"
		, "UrlList"			: "http://localhost:8080/Cloud2Oracle/db/f_list.jsp"
		, "UrlDel"			: "http://localhost:8080/Cloud2Oracle/db/f_del.jsp"
	    //x86
        , ie: {
